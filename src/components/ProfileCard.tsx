...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  return (
    <div
      ref={wrapRef}
      className={className}
      style={{ width: '80%', margin: '0 auto', position: 'relative', touchAction: 'none', perspective: '500px', transform: 'translate3d(0, 0, 0.1px)', ...cardStyle } as React.CSSProperties}
    >
      {behindGlowEnabled && (
        <div
          style={{
            position: 'absolute', top: 0, right: 0, bottom: 0, left: 0, zIndex: 0, pointerEvents: 'none', transition: 'opacity 200ms ease-out',
      ...
      <div ref={shellRef} style={{ width: '100%', position: 'relative', zIndex: 1 }}>
        <section
          style={{
            display: 'grid',
            position: 'relative',
        ...
        >
          ...
          >
              ...
              {showUserInfo && (
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                    <div
                      style={{
                        borderRadius: '9999px', overflow: 'hidden', border: '1px solid rgba(255, 255, 255, 0.1)', flexShrink: 0, width: '48px', height: '48px'
                      }}
                    >
                      <img
                        ...
                        loading="lazy"
                        style={{ display: 'block', gridArea: 'auto', borderRadius: '50%', pointerEvents: 'auto', width: '100%', height: '100%', objectFit: 'cover' }}
                        onError={e => {
                          const t = e.target as HTMLImageElement;
                          t.style.opacity = '0.5';
                          t.src = avatarUrl;
                  ...
                  <button
                    ...
                    style={{
                      border: '1px solid rgba(255, 255, 255, 0.1)', borderRadius: '8px', padding: '12px 16px', fontSize: '12px', fontWeight: 600, color: 'rgba(255, 255, 255, 0.9)', cursor: 'pointer', backdropFilter: 'blur(10px)', transition: 'all 200ms ease-out', pointerEvents: 'auto', display: 'block', gridArea: 'auto', background: 'transparent'
                    }}
                    type="button"
            ...
            >
              <div style={{ position: 'absolute', width: '100%', top: '3em', display: 'flex', flexDirection: 'column', gridArea: 'auto' }}>
                <h3
                  style={{
                    margin: 0,
                    fontWeight: 600,
